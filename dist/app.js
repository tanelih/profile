...
},{"component-emitter":192}],186:[function(require,module,exports){
/**
...
},{"./application":185,"./render":189,"./stringify":190}],188:[function(require,module,exports){
...
},{"component-type":194}],189:[function(require,module,exports){
/**
 * Dependencies.
 */
...
},{"./events":186,"./node-type":188,"./svg":191,"component-raf":193,"fast.js/forEach":197,"fast.js/object/assign":200,"fast.js/reduce":203,"get-uid":204,"is-dom":205,"object-defaults":208,"object-path":209}],190:[function(require,module,exports){
var defaults = require('object-defaults')
var nodeType = require('./node-type')
var type = require('component-type')
...
},{"./node-type":188,"component-type":194,"object-defaults":208}],191:[function(require,module,exports){
module.exports = {
...
},{"is-svg-attribute":206,"is-svg-element":207}],192:[function(require,module,exports){
...
},{"../function/bindInternal3":198}],196:[function(require,module,exports){
'use strict';
...
},{"../function/bindInternal4":199}],197:[function(require,module,exports){
'use strict';
...
},{"./array/forEach":195,"./object/forEach":201}],198:[function(require,module,exports){
'use strict';
...
},{"../function/bindInternal3":198}],202:[function(require,module,exports){
'use strict';
...
},{"../function/bindInternal4":199}],203:[function(require,module,exports){
'use strict';
...
},{"./array/reduce":196,"./object/reduce":202}],204:[function(require,module,exports){
...
},{"array-flatten":211,"sliced":212}],211:[function(require,module,exports){
'use strict'
...
},{"./lib/sliced":213}],213:[function(require,module,exports){
...
var _appViewsUser = require('app/views/user');

var UserView = _interopRequireWildcard(_appViewsUser);

var tree = _deku2['default'].tree((0, _virtualElement2['default'])(UserView, { name: 'pmatilainen' }));

_deku2['default'].render(tree, document.getElementById('app'));

},{"app/views/user":218,"babel/polyfill":183,"deku":187,"virtual-element":210,"whatwg-fetch":214}],216:[function(require,module,exports){
'use strict';
...
function render(_ref) {
	...
	return (0, _virtualElement2['default'])(
		'section',
		{ 'class': 'avatar' },
		(0, _virtualElement2['default'])('img', { src: props.url })
	);
}

},{"virtual-element":210}],217:[function(require,module,exports){
/**
 * Map containing the keys we want to extract from the response and the alias
 * we should use for the result.
 */
'use strict';
...
/**
 * Shortcuts for some useful stuff...
 */
...
/**
 * Convert response properties based on the given property map.
 */
var convertProperties = function convertProperties(map) {
  return function (res) {
    return reduce(Object.keys(res), function (props, key) {
      return has(map, key) ? Object.assign({}, props, _defineProperty({}, map[key], res[key])) : props;
    });
  };
};
...
function getUser(name) {
  return fetch('https://api.github.com/users/' + name).then(function (response) {
    return response.json();
  }).then(convertProperties(UserPropertyMap));
}
...
var _appUtilsGithub = require('app/utils/github');

var _appComponentsAvatar = require('app/components/avatar');

var Avatar = _interopRequireWildcard(_appComponentsAvatar);
