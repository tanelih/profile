...
_deku2['default'].render(_deku2['default'].tree((0, _virtualElement2['default'])(UserView, { name: 'tanelih' })), document.getElementById('app'));
...
var render = function render(_ref) {
  ...
  return (0, _virtualElement2["default"])(
    ...
    (0, _virtualElement2["default"])(
      "a",
      { href: "https://github.com/" + props.user.name },
      (0, _virtualElement2["default"])("img", { "class": "avatar", src: props.user.avatar })
    ),
    (0, _virtualElement2["default"])(
      "section",
      { "class": "info" },
...
exports.render = render;
var linkToRepo = function linkToRepo(repo) {
  return "https://github.com/" + repo.owner.name + "/" + repo.name;
};

var renderRepositoryTitle = function renderRepositoryTitle(repo) {
  return (0, _virtualElement2["default"])(
    "div",
    { "class": "repository-title" },
    (0, _virtualElement2["default"])(
      "a",
      { "class": "link", href: linkToRepo(repo), target: "_blank" },
      repo.name
    ),
    (0, _virtualElement2["default"])(
      "span",
...
var renderOwnedRepository = function renderOwnedRepository(repo) {
  return (0, _virtualElement2["default"])(
    "li",
    { "class": "repository owned" },
    ...
    (0, _virtualElement2["default"])(
      ...
      " stars | last updated at ",
      (0, _virtualElement2["default"])(
        "strong",
        null,
        new Date(repo.lastUpdate).toDateString()
      )
    )
  );
};

var renderForkedRepository = function renderForkedRepository(repo) {
  return (0, _virtualElement2["default"])(
    "li",
    { "class": "repository forked" },
    renderRepositoryTitle(repo),
    (0, _virtualElement2["default"])(
      "div",
      { "class": "description" },
    ...
    (0, _virtualElement2["default"])(
      ...
      (0, _virtualElement2["default"])(
        "a",
        { href: linkToRepo(repo.parent), target: "_blank" },
...
var afterMount = function afterMount(_ref2, el, set) {
  var state = _ref2.state;
  var props = _ref2.props;
  return(
    // fetch the necessary data from the server
    (0, _appUtilsGithub.getUser)(props.name).then(function (user) {
      return (0, _appUtilsGithub.getRepositories)(user.name).then(function (repos) {
        return(
          ...
          Promise.all(repos.map(function (repo) {
            return repo.fork ? (0, _appUtilsGithub.getRepository)(user.name, repo.name).then(function (repo) {
              return (0, _appUtilsGithub.getContributors)(repo.parent.owner.name, repo.parent.name).then(function (contributors) {
